...
if __name__ == '__main__':
    # train 从train中移动
    train_img_Dir = '/root/autodl-tmp/Yolov5_IP102/images/'
    train_mask_Dir = '/root/autodl-tmp/Yolov5_IP102/labels/'
    # test路径：图片和标注目录
    test_img_Dir = '/root/autodl-tmp/Yolov5_IP102/test/images/'
    test_mask_Dir = '/root/autodl-tmp/Yolov5_IP102/test/labels/'
    # val路径：图片和标注文目录
    val_img_Dir = '/root/autodl-tmp/Yolov5_IP102/val/images/'
    val_mask_Dir = '/root/autodl-tmp/Yolov5_IP102/val/labels/'
    # 运行划分数据集函数
